...
for (let i = 0; i < domMethods.length; i++) {
  domMethods[i].style.color = 'red';
}
...
const domMethodsAll = document.querySelectorAll('.dom-methods');
for (let i = 0; i < domMethodsAll.length; i++) {
  domMethodsAll[i].style.fontSize = '20px';
}
